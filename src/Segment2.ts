...
export class Segment2 {
     ...
     */
    isPerpendicular(segment: Segment2, tolerance: number = EPSILON) {
    ...
    */
    ...
    /**
     * Get the tangent vector of this segment (perpendicular of direction)
     */
    getTangent() {
    ...
    /**
     * Test for intersection intersection bw
     * @param p1 first point of segment 1
     * @param p2 last point of segment 1
     * @param p3 first point of segment 2
     * @param p4 last point of segment 2
     */
...
function CCW(p: Vector2, q: Vector2, r: Vector2) {
